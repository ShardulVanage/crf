  ...
  return (
    <nav className="mt-px font-display text-5xl font-medium tracking-tight text-white">
      ...
      <NavigationRow>
        ...
        <NavigationItem href="/blog"><h1 className='text-5xl font-extrabold text-transparent bg-clip-text hover:bg-gradient-to-br from-sky-500 via-indigo-500 to-red-500 bg-white'>Journals</h1></NavigationItem>
      </NavigationRow>
    </nav>
  )
}
